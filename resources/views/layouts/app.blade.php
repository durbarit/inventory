...
<html lang="en">
    <head>
        ...
        <!--bootstrap-->
        <link rel="stylesheet" href="{{asset('public/contents/admin/assets/css/bootstrap.min.css')}}">
        <!--font awesome-->
        <link rel="stylesheet" href="{{asset('public/contents/admin/assets/css/all.css')}}">

         <!-- START PAGE LABEL PLUGINS -->
        <link rel="stylesheet" href="{{asset('public/contents/admin/assets/plugins/datatables/dataTables.min.css')}} ">
        <!-- metis menu -->
        <link rel="stylesheet" href="{{asset('public/contents/admin/assets/plugins/metismenu-3.0.4/assets/css/metisMenu.min.css')}}">
        <link rel="stylesheet" href="{{asset('public/contents/admin/assets/plugins/metismenu-3.0.4/assets/css/mm-vertical-hover.css')}}">
        <!-- chart -->
         <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.css">
        <!-- <link rel="stylesheet" href="assets/plugins/chartjs-bar-chart/chart.css"> -->

        <!--Custom CSS-->
        <link rel="stylesheet" href="{{asset('public/contents/admin/assets/css/style.css')}}">
    </head>
    <body id="page-top">
        <!-- preloader -->
       {{--  <div class="preloader">
            <img src="{{ asset('public/contents/admin/assets/images/preloader.gif')}}" alt="">
        </div> --}}
        <!-- wrapper -->
        <div class="wrapper">
           @guest
           @else
            ...
            <header class="header_area">
                ...
                <div class="sidebar_logo">
                    <a href="index.html">
                        <img src="{{ asset('public/contents/admin/assets/images/logo.png')}}" alt="" class="img-fluid logo1">
                        <img src="{{ asset('public/contents/admin/assets/images/logo_small.png')}}" alt="" class="img-fluid logo2">
                    </a>
                </div>
                   ...
                   <li class="single-nav-wrapper">
                          <a class="has-arrow menu-item" href="#" aria-expanded="false">
                            ...
                            <ul class="dashboard-menu">
                              ...
                              <li><a href="{{url('/list/category')}}">All Category</a></li>
                            </ul>
                    </li>
                    <li class="single-nav-wrapper">
                          <a class="has-arrow menu-item" href="#" aria-expanded="false">
                            ...
                            <ul class="dashboard-menu">
                              ...
                              <li><a href="{{url('/list/brand')}}">All Brand</a></li>
                            </ul>
                      </li>
                      <li class="single-nav-wrapper">
                          <a class="has-arrow menu-item" href="#" aria-expanded="false">
                            ...
                            <ul class="dashboard-menu">
                              ...
                              <li><a href="{{url('/list/designation')}}">All Designation</a></li>
                            </ul>
                      </li>
                      <li class="single-nav-wrapper">
                          <a class="has-arrow menu-item" href="#" aria-expanded="false">
        ...
        <!-- popper Min Js -->
        <script src="{{asset('public/contents/admin/assets/js/popper.min.js')}}"></script>
        <!-- Bootstrap Min Js -->
        <script src="{{asset('public/contents/admin/assets/js/bootstrap.min.js')}}"></script>
        <!-- Fontawesome-->
        <script src="{{asset('public/contents/admin/assets/js/all.min.js')}}"></script>
        <!-- metis menu -->
        <script src="{{asset('public/contents/admin/assets/plugins/metismenu-3.0.4/assets/js/metismenu.js')}}"></script>
        <script src="{{asset('public/contents/admin/assets/plugins/metismenu-3.0.4/assets/js/mm-vertical-hover.js')}}"></script>
        <!-- nice scroll bar -->
        <script src='{{asset('public/contents/admin/assets/plugins/scrollbar/jquery.nicescroll.min.js')}}'></script>
        <script src="{{asset('public/contents/admin/assets/plugins/scrollbar/scroll.active.js')}}"></script>
        <!-- counter -->
        <script src="{{asset('public/contents/admin/assets/plugins/counter/js/counter.js')}}"></script>
        <!-- chart -->
        <script src='{{asset('public/contents/admin/assets/plugins/chartjs-bar-chart/Chart.min.js')}}'></script>
        <script src="{{asset('public/contents/admin/assets/plugins/chartjs-bar-chart/chart.js')}}"></script>
        <!-- pie chart -->
        <script src="{{asset('public/contents/admin/assets/plugins/pie_chart/chart.loader.js')}}"></script>
        <script src="{{asset('public/contents/admin/assets/plugins/pie_chart/pie.active.js')}}"></script>
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/js/toastr.min.js"></script>

        <script src="{{ asset('https://unpkg.com/sweetalert/dist/sweetalert.min.js')}}"></script>
        <!-- DataTable Js -->
        <script src="{{asset('public/contents/admin/assets/plugins/datatables/dataTables.min.js')}}"></script>
        <script src="{{asset('public/contents/admin/assets/plugins/datatables/dataTables-active.js')}}"></script>
        <!-- Main js -->
        <script src="{{asset('public/contents/admin/assets/js/main.js')}}"></script>
